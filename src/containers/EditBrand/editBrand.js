...
import { getBrandDetails,updateBrandDetails} from "../../actions/brandsAction";
...
class EditBrands extends Component {
  state = {
    ...
    selected: "Enabled",
    fileName:[],
    picture:this.props.brandDetail.logo_url,
    isReadOnly:true,
  ...
  saveBrandDetails=(event)=>{
    event.preventDefault();
    const{brandName,description,selected}=this.state;
    
      let payload={
        name:brandName?brandName:this.props.brandDetail.name,
        description:description?description:this.props.brandDetail.description,
        status:selected,
        // logo:picture?picture:this.props.brandDetail.logo_url,
      }
